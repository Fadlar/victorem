import { r as o, j as i, d as I, y as h } from "./app-2UknqXgy.js";
import { A as D } from "./App-OpPn3YkP.js";
import { V as H } from "./index-CkMAcVi9.js";
import { r as c } from "./routes-0mvJeivy.js";
import { P as A } from "./page-header-mh2v6ut1.js";
import { n as f } from "./notification-n4E3ZUKo.js";
import L from "./edit-product-form-R1SrcONd.js";
...
const S = {
    ...
    breadcrumb: [
        { href: "#", name: "Home" },
        { href: c.eCommerce.products, name: "Products" },
        { name: "Edit" },
    ],
};
function de({ product: t, categories: C }) {
    const [n, p] = o.useState(t.categories ?? []),
        [r, a] = o.useState({
            name: t.name ?? "",
            description: t.description ?? "",
            categories: t.categories ?? [],
            price: t.price ?? "",
            agent_price: t.agent_price ?? "",
            stock: t.stock ?? "",
            weight: t.weight ?? "",
        }),
        [w, l] = o.useState([]),
        ...
        v = (e) => {
            p((m) => m.filter((s) => s.id !== e));
        },
        F = (e) => {
            e.preventDefault(),
                h.post(
                    c.eCommerce.updateProduct(t.slug),
                    {
                        _method: "patch",
                        name: r.name,
                    ...
                    },
                    {
                        preserveScroll: !0,
                        onSuccess: () => {
                            f("Product has been updated.", "success"),
                                a({}),
                                u({}),
                                l([]),
                                b(!0),
                                h.visit(c.eCommerce.editProduct(t.slug), {
                                    only: ["product"],
                                });
                        },
                        onStart: () => d(!0),
                        onFinish: () => d(!1),
                        onError: (m) => {
                            f("Something went wrong.", "error"), u(m);
                        },
                    },
                );
        };
