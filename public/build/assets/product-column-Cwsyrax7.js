import { j as e, d as C, y as m } from "./app-2UknqXgy.js";
import { H as c, P as j, D as H } from "./delete-popover-FTqRtOPN.js";
import {
    B as V,
    E as k,
    H as p,
    ...
    I as y,
    C as v,
} from "./index-CkMAcVi9.js";
import { r } from "./routes-0mvJeivy.js";
import { A as M } from "./utils-FzIoAioV.js";
import { t as i } from "./lang-ZDB8uS83.js";
import { n as Z } from "./notification-n4E3ZUKo.js";
import { N as x } from "./react-number-format.es-jsVA24o-.js";
...
const q = ({
    ...
    {
        title: e.jsx(c, { title: i("Product Info") }),
        dataIndex: "icon",
        key: "icon",
        width: 150,
        render: (s, a) =>
    ...
    {
        title: e.jsx(c, {
            title: i("Customer Price"),
            sortable: !0,
            ascending:
                (t == null ? void 0 : t.direction) === "asc" &&
                (t == null ? void 0 : t.key) === "price",
        }),
        dataIndex: "price",
        key: "price",
        width: 100,
        onHeaderCell: () => d("price"),
        render: (s) =>
            e.jsx(l, {
                className: "!text-sm",
                children: e.jsx(x, {
    ...
    },
    {
        title: e.jsx(c, {
            ...
            ascending:
                (t == null ? void 0 : t.direction) === "asc" &&
                (t == null ? void 0 : t.key) === "agent_price",
        }),
        dataIndex: "agent_price",
        key: "agent_price",
        width: 100,
        onHeaderCell: () => d("agent_price"),
        render: (s) =>
            e.jsx(l, {
                className: "!text-sm",
                children: e.jsx(x, {
    ...
    },
    {
        title: e.jsx(c, {
            ...
            ascending:
                (t == null ? void 0 : t.direction) === "asc" &&
                (t == null ? void 0 : t.key) === "stock",
        }),
        onHeaderCell: () => d("stock"),
        dataIndex: "stock",
        key: "stock",
        width: 5,
        render: (s) => e.jsx(l, { children: s }),
    },
    {
        title: e.jsx(l, { children: "Active" }),
        dataIndex: "status",
        key: "status",
        width: 15,
        render: (s, a) => {
            const n = s === "publish",
                ...
                o = () => {
                    m.put(
                        r.eCommerce.changeProductStatus(a.slug),
                        {},
                        {
                            onSuccess: () => {
                                Z(h, "success"),
                                    m.visit(r.eCommerce.products, {
                                        only: ["product"],
                                    });
                            },
                        },
            ...
            return e.jsx(y, { checked: n, onChange: o });
        },
    },
    {
            ...
            e.jsxs("div", {
                ...
                children: [
                    e.jsx(p, {
                        ...
                        color: "invert",
                        children: e.jsx(C, {
                            href: r.eCommerce.editProduct(a.slug),
                            children: e.jsx(v, {
                                size: "sm",
                                variant: "outline",
                    ...
                    e.jsx(H, {
                        ...
                        description: `Are you sure you want to delete this #${a.slug} product?`,
                        onDelete: () => u(a.slug),
                    }),
                ],
            }),
