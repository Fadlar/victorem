    ...
    <section class="shop-details">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3">
                        <ul class="nav nav-tabs" role="tablist">
                            @foreach ($product->images as $index => $image)
                                <li class="nav-item">
                                    <a class="nav-link {{ $index === 0 ? 'active' : '' }}" data-toggle="tab" href="#tabs-{{ $image->id }}" role="tab">
                                        <div class="product__thumb__pic set-bg" data-setbg="{{ '/storage/' . $image->url }}">
                                        </div>
                                    </a>
                                </li>
                            @endforeach
                    ...
                    <div class="col-lg-6 col-md-9">
                        <div class="tab-content">
                            @foreach ($product->images as $index => $image)
                                <div class="tab-pane {{ $index === 0 ? 'active' : '' }}" id="tabs-{{ $image->id }}" role="tabpanel">
        ...
        <div class="product__details__content">
            <div class="container">
                            ...
                            <ul style="list-style: none;">
                                <li><span>Categories:</span>
                                    @foreach ($product->categories as $category)
                                        <a class="text-dark" href="/product?category={{ $category->slug }}">{{ $category->name }}@if (!$loop->last)
                                                ,
                                            @endif
                                        </a>
                                    @endforeach
                ...
                <div class="row mb-5">
                    <div class="col-lg-12">
                        <div class="pt-5 product__details__tab">
                            <div class="tab-content">
