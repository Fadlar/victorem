export const routes = {
    ...
    eCommerce: {
        ...
        updateProduct: (slug: string) => `/ecommerce/products/${slug}`,
        destroyProduct: (slug: string) => `/ecommerce/products/${slug}`,
        changeProductStatus: (slug: string) =>
            `/ecommerce/change-product-status/${slug}`,
        // Categories
        categories: "/ecommerce/categories",
        editCategory: (slug: string) => `/ecommerce/categories/${slug}/edit`,
        updateCategory: (slug: string) => `/ecommerce/categories/${slug}`,
        destroyCategory: (slug: string) => `/ecommerce/categories/${slug}`,
        // Discounts
        discounts: "/ecommerce/discounts",
        createDiscount: "/ecommerce/discounts/create",
        editDiscount: (id: number) => `/ecommerce/discounts/${id}/edit`,
        udDiscount: (id: number) => `/ecommerce/discounts/${id}`,
        // Vouchers
        vouchers: "/ecommerce/vouchers",
        editVoucher: (id: number) => `/ecommerce/vouchers/${id}/edit`,
        udVoucher: (id: number) => `/ecommerce/vouchers/${id}`,
        ...
        editUser: (id: any) => `/admin/users/${id}/edit`,
        showUser: (id: any) => `/admin/users/${id}`,
    },
    searchAndFilter: {
