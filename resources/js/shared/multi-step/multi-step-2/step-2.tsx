...
import FormPart from "@/shared/multi-step/form-part";
import BasicInfo, {
    BasicInfoSchema,
    basicInfoValues,
} from "@/shared/multi-step/basic-info";
import UploadPhoto from "@/shared/multi-step/upload-photo";
import AccommodationInfo, {
    AccommodationSchema,
    accommodationValues,
} from "@/shared/multi-step/accommodation-info";
import { useStepperOne } from "@/shared/multi-step/multi-step-1";
import Footer from "@/multi-step/form-two/footer";
