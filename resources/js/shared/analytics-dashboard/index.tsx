import WebsiteMetrics from "@/shared/analytics-dashboard/website-metrics/table-widget";
...
import PageMetrics from "@/shared/analytics-dashboard/page-metric/table-widget";
