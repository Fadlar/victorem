            ...
            <div className="space-y-4 [&_label]:block">
                <Collapse
                    className={cn(
                        ...
                        collapseOpen &&
                            "ring-2 ring-gray-1000 hover:!border-gray-200",
                    )}
                    defaultOpen={true}
                    header={({ open, toggle }) => (
                        <button
                        ...
                        >
                            <div className="pe-6">
                                ...
                                <Text className="hidden leading-[1.85] @2xl:block">
                                    Before placing an order with a large payment
                                    amount, We recommend contacting the card
                                    issuing bank/institution to avoid the bank
                                    flagging your payment or withholding the
                                    funds.
                                </Text>
                            </div>
                                ...
                                <Controller
                                    ...
                                    render={({
                                        ...
                                        <NumberInput
                                            ...
                                            mask="_"
                                            customInput={
                                                Input as React.ComponentType<unknown>
                                            }
                                            {...{
                                                variant: "outline",
                                            }}
