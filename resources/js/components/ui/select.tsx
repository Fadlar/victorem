    ...
    variant: {
        ...
        flat: {
            ...
            color: {
                ...
                success:
                    "bg-green-lighter/70 focus:ring-green/30 text-green-dark",
                warning:
        ...
        outline: {
            ...
            color: {
                ...
                success:
                    "hover:border-green focus:border-green focus:ring-green",
                warning:
                    "hover:border-orange focus:border-orange focus:ring-orange",
            },
        },
        text: {
...
> & {
    ...
    displayValue?(
        value: ExtractProps<typeof Listbox>["value"],
    ): React.ReactNode;
                    ...
                    <>
                        {label && (
                            ...
                            >
                                {label}
                                {isRequired && (
                                    <span className="ms-1 font-medium text-red-light">
                                        *
                                    </span>
                                )}
                            </Listbox.Label>
                        ...
                        >
                            <Listbox.Button
                                className={cn(
                                    ...
                                    prefix &&
                                        selectFieldClasses.prefixStartPadding
                                            .size[size],
                                    suffix &&
                                        selectFieldClasses.suffixEndPadding
                                            .size[size],
