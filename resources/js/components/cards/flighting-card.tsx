...
import { flightListingData } from "@/shared/explore-flight/listing-filters/filter-utils";
...
export default function FlightingCard() {
    ...
    const filteredData = flightListingData;
    // hasSearchedParams()
                    ...
                    <div className="flex gap-2 sm:items-center md:gap-4">
                        ...
                        <div className="sm:flex sm:flex-col">
                            ...
                            <ul className="flex items-center divide-x">
                                ...
                                <li className="hidden px-1.5 md:block">
                                    {flight.hours}
                                </li>
                                <li className="hidden px-1.5 md:block">
                                    {flight.stop}
